...
export default function FindJobLoading () {
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
      ...
      <div className="mt-12">
        <div className="h-7 bg-gray-200 rounded animate-pulse w-32 mb-8"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="h-5 bg-red-100 rounded-full animate-pulse w-16"></div>
            </div>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-pink-100 rounded animate-pulse"></div>
              <div className="flex-1">
                <div className="h-4 bg-gray-200 rounded animate-pulse w-20 mb-1"></div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-gray-200 rounded-full animate-pulse"></div>
          ...
          {/* Related Job Card 3 */}
          <div className="border border-gray-200 rounded-lg p-6 md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-green-100 rounded animate-pulse"></div>
              <div className="flex-1">
                <div className="h-4 bg-gray-200 rounded animate-pulse w-16 mb-1"></div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-gray-200 rounded-full animate-pulse"></div>
            ...
            <div className="flex items-center gap-4 text-sm">
              <div className="h-4 bg-gray-200 rounded animate-pulse w-16"></div>
              <div className="h-4 bg-gray-200 rounded animate-pulse w-22"></div>
            </div>
          </div>
        </div>
      </div>
