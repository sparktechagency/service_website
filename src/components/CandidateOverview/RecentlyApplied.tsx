        ...
        <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
          ...
          <div className="divide-y divide-gray-200">
            ...
            <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-12 md:gap-6 md:p-6 hover:bg-blue-50 duration-200">
              ...
              <div className="col-span-3 flex items-center justify-end">
                <button
                  onClick={() => router.push(`/job-details/${3}`)}
                  className="rounded-md bg-gray-100 text-primary border border-gray-300 hover:border-primary hover:bg-primary hover:text-white duration-200 cursor-pointer px-4 py-2 text-sm font-medium"
                >
                  View Details
                </button>
              </div>
