      ...
      >
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="bg-blue-50 cursor-pointer hover:bg-primary hover:text-white text-primary px-4 py-2 rounded-md flex items-center duration-200 transition-colors"
          >
            View Details
          </button>
        </div>
