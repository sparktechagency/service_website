...
import { Bell, Bookmark, BriefcaseIcon, ChevronRight, LogOut, Settings } from "lucide-react"
        ...
        <div className="mx-auto max-w-5xl p-4 md:p-6 lg:p-8">
          ...
          <div className="mb-8 overflow-hidden rounded-lg bg-red-200 p-4 sm:p-6">
            <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-1 items-center gap-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Your profile editing is not completed.</h3>
                  <p className="text-sm text-gray-700">Complete your profile editing & build your custom Resume</p>
                </div>
              </div>
          ...
          <div className="mb-6">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-medium text-gray-900">Recently Applied</h2>
              ...
              <div className="divide-y divide-gray-200">
                ...
                <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-12 md:gap-6 md:p-6">
                  ...
                  <div className="col-span-3 flex items-center text-sm text-gray-500 md:justify-start">
                    <span className="md:hidden font-medium text-gray-700 mr-1">Date: </span>
                    Feb 2, 2019 19:28
                  </div>
